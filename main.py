...
if __name__ == '__main__':
    ...
    if opt.if_real_data:
        # opt.max_seq_len, opt.vocab_size = text_process('dataset/' + opt.dataset + '.txt') # Descomentar si se desea usar como largo, el mayor encontrado dentro del train dataset
        sequence_len, opt.vocab_size = text_process('dataset/' + opt.dataset + '.txt')
